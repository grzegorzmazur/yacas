//
// "$Id: HelpView.h,v 1.1 2006-02-17 13:08:41 peterdgilbert Exp $"
//
...
struct HelpLink
{
  ...
  int      	y;		// Y offset of link text
  int		x,		// X offset of link text
		w;		// Width of link text
  int      	h;		// Height of link text
};
...
//
// End of "$Id: HelpView.h,v 1.1 2006-02-17 13:08:41 peterdgilbert Exp $".
//
