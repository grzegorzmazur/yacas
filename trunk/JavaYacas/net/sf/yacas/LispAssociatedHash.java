 ...
 * link to the string, and this class then stores that information for a string.
 * It is in a sense a way to extend the string object without modifying the
 * string class itself. This class does not own the strings it points to, but
 * instead relies on the fact that the strings are maintained in a hash table
 * (like LispHashTable above).
 */
