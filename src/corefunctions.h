...
CORE_KERNEL_FUNCTION("Dll'Directory",YacasDllDirectory,1,YacasEvaluator::Function | YacasEvaluator::Fixed)
...
CORE_KERNEL_FUNCTION("Dll'Load",YacasDllLoad,1,YacasEvaluator::Function | YacasEvaluator::Fixed)
CORE_KERNEL_FUNCTION("Dll'Unload",YacasDllUnload,1,YacasEvaluator::Function | YacasEvaluator::Fixed)
CORE_KERNEL_FUNCTION("Dll'Enumerate",YacasDllEnumerate,0,YacasEvaluator::Function | YacasEvaluator::Fixed)
