...
dnl
dnl @version $Id: acinclude.m4,v 1.8 2003-03-08 23:26:05 ayalpinkus Exp $
...
dnl ------------------------------------------------------------
dnl
dnl We are including a copy of gsl.m4 as distributed together with
...
dnl ------------------------------------------------------------
dnl
dnl We are including a copy of libtool.m4 whose version matches the
dnl 'ltmain.sh' file distributed with Yacas. It is mentioned in the 
dnl libtool documentation that this is a good idea, as otherwise the
dnl libtool.m4 of the local machine would be used, which might have a
dnl different version.
...
#    archive_cmds='$nonopt $(test .$module = .yes && echo -bundle || echo -dynamiclib) $allow_undefined_flag -o $lib
